...
public class MongoLogHandlerConfiguration extends AbstractLogHandlerConfiguration<MongoProperties> {
	...
	public MongoDatabaseFactory mongoDatabaseFactory(
			@Qualifier("loggingMongoClient") ObjectProvider<MongoClient> mongoClient) {
		String databaseName;
	...
	public MongoMappingContext mongoMappingContext(
			@Qualifier("loggingMongoCustomConversions") ObjectProvider<MongoCustomConversions> mongoCustomConversion) {
	...
	@Bean(name = "loggingMongoMappingMongoConverter")
	@ConditionalOnMissingBean(name = "loggingMongoMappingMongoConverter")
	public MappingMongoConverter mappingMongoConverter(
			@Qualifier("loggingMongoDatabaseFactory") ObjectProvider<MongoDatabaseFactory> mongoDatabaseFactory,
			@Qualifier("loggingMongoMappingContext") ObjectProvider<MongoMappingContext> mongoMappingContext,
			@Qualifier("loggingMongoCustomConversions") ObjectProvider<MongoCustomConversions> mongoCustomConversion) {
	...
	public MongoTemplate mongoTemplate(
			@Qualifier("loggingMongoDatabaseFactory") ObjectProvider<MongoDatabaseFactory> mongoDatabaseFactory,
			@Qualifier("loggingMongoMappingMongoConverter") ObjectProvider<MappingMongoConverter> mappingMongoConverter) {
	...
	public MongoLogHandlerFactoryBean logHandlerFactoryBean(
			@Qualifier("loggingMongoTemplate") ObjectProvider<MongoTemplate> mongoTemplate) {
