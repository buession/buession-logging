...
/**
 * {@link MongoMappingContext} 工厂 Bean
 *
 * @author Yong.Teng
 * @since 0.0.1
 */
public class MongoMappingContextFactoryBean extends MongoMappingContextFactory
		implements FactoryBean<MongoMappingContext>, InitializingBean {
