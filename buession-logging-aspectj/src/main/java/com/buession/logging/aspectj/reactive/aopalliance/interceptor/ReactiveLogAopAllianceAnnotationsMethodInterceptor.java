 ...
 * +-------------------------------------------------------------------------------------------------------+
 */
package com.buession.logging.aspectj.reactive.aopalliance.interceptor;
 ...
 * @since 0.0.1
 */
public class ReactiveLogAopAllianceAnnotationsMethodInterceptor extends
		AbstractLogAopAllianceAnnotationsMethodInterceptor {

	public ReactiveLogAopAllianceAnnotationsMethodInterceptor(LogManager logManager) {
		super(logManager);
	}

	@Override
	protected LogAnnotationHandler createLogAnnotationHandler(LogManager logManager) {
		return new ReactiveLogAnnotationHandler(logManager);
	}

	@Override
	protected AuditLogAnnotationHandler createAuditLogAnnotationHandler(LogManager logManager) {
		return new ReactiveAuditLogAnnotationHandler(logManager);
	}
