 ...
 * +-------------------------------------------------------------------------------------------------------+
 */
package com.buession.logging.aspectj.servlet.aopalliance.interceptor;
 ...
 * @since 0.0.1
 */
public class ServletLogAopAllianceAnnotationsMethodInterceptor extends
		AbstractLogAopAllianceAnnotationsMethodInterceptor {

	public ServletLogAopAllianceAnnotationsMethodInterceptor(LogManager logManager) {
		super(logManager);
	}
