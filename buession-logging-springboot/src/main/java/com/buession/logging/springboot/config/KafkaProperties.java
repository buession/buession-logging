...
public class KafkaProperties implements AdapterProperties, KafkaConfiguration, Serializable {
	...
	/**
	 * Return serializer class for keys.
	 *
	 * @return The serializer class for keys.
	 */
	...
	/**
	 * Sets serializer class for keys.
	 *
	 * @param keySerializer
	...
	/**
	 * Return serializer class for value.
	 *
	 * @return The serializer class for value.
	 */
	...
	/**
	 * Sets serializer class for value.
	 *
	 * @param valueSerializer
	 * 		The serializer class for value.
	 */
	...
	public Map<String, Object> buildProperties() {
		...
		propertyMapper.from(this::getKeySerializer)
				.to((value)->properties.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, value));
		propertyMapper.from(this::getValueSerializer)
