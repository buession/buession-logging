 ...
 * +-------------------------------------------------------------------------------------------------------+
 */
package com.buession.logging.aop.reactive.aspect.interceptor;
...
public class ReactiveWebAspectAnnotationsMethodInterceptor extends AbstractAspectjAnnotationsMethodInterceptor {
	...
	public ReactiveWebAspectAnnotationsMethodInterceptor() {
		...
		methodInterceptors.add(new ReactiveLogAnnotationMethodInterceptor());
		methodInterceptors.add(new ReactiveAuditLogAnnotationMethodInterceptor());
