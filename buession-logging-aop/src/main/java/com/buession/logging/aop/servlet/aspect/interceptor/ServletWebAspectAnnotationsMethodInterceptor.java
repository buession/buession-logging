 ...
 * +-------------------------------------------------------------------------------------------------------+
 */
package com.buession.logging.aop.servlet.aspect.interceptor;
...
public class ServletWebAspectAnnotationsMethodInterceptor extends AbstractAspectjAnnotationsMethodInterceptor {
	...
	public ServletWebAspectAnnotationsMethodInterceptor() {
		...
		methodInterceptors.add(new ServletLogAnnotationMethodInterceptor());
		methodInterceptors.add(new ServletAuditLogAnnotationMethodInterceptor());
