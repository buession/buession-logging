...
import com.buession.logging.aop.handler.AbstractLogAnnotationHandler;
 ...
 * @since 0.0.1
 */
public class ServletLogAnnotationHandler extends AbstractLogAnnotationHandler {

	private final static Logger logger = LoggerFactory.getLogger(ReactiveContentTypeAnnotationHandler.class);

	public ServletLogAnnotationHandler() {
		super();
	}
