...
/**
 * {@link JdbcTemplate} 工厂 Bean
 *
 * @author Yong.Teng
 * @since 0.0.1
 */
public class JdbcTemplateFactoryBean extends JdbcTemplateFactory implements FactoryBean<JdbcTemplate>,
		InitializingBean {
	...
	@Override
	public Class<JdbcTemplate> getObjectType() {
